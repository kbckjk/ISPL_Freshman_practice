...
from preprocess import read_tfrecord, write_tfrecord
...
class Classifier(object):
    ...
    def test(self):
        #write tfrecord
        write_tfrecord(self.args.imagedir, self.args.test_datadir+'/mnist.tfrecord', '', 1)
        # load data
        ts_img, ts_lab = read_tfrecord(self.args.test_datadir, self.args.batch, 100)
